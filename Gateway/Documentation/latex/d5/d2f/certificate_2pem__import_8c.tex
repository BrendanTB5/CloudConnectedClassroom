\hypertarget{certificate_2pem__import_8c}{}\section{cyclone\+\_\+crypto/certificate/pem\+\_\+import.c File Reference}
\label{certificate_2pem__import_8c}\index{cyclone\+\_\+crypto/certificate/pem\+\_\+import.\+c@{cyclone\+\_\+crypto/certificate/pem\+\_\+import.\+c}}
{\ttfamily \#include \char`\"{}core/crypto.\+h\char`\"{}}\newline
{\ttfamily \#include \char`\"{}certificate/pem\+\_\+import.\+h\char`\"{}}\newline
...
\mbox{\Hypertarget{certificate_2pem__import_8c_a861695b3eda2ba8ca5ea2a5b2715c152}\label{certificate_2pem__import_8c_a861695b3eda2ba8ca5ea2a5b2715c152}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Certificate@{pem\+Import\+Certificate}}
\index{pem\+Import\+Certificate@{pem\+Import\+Certificate}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
\subsubsection{\texorpdfstring{pem\+Import\+Certificate()}{pemImportCertificate()}}
{\footnotesize\ttfamily \hyperlink{error_8h_ac7659d73a8cdedc08e9f566bb406689c}{error\+\_\+t} pem\+Import\+Certificate (\begin{DoxyParamCaption}\item[{const \hyperlink{compiler__port_8h_a40bb5262bf908c328fbcfbe5d29d0201}{char\+\_\+t} $\ast$$\ast$}]{input,  }\item[{size\+\_\+t $\ast$}]{input\+Len,  }\item[{\hyperlink{stdint_8h_aba7bc1797add20fe3efdf37ced1182c5}{uint8\+\_\+t} $\ast$$\ast$}]{output,  }\item[{size\+\_\+t $\ast$}]{output\+Size,  }\item[{size\+\_\+t $\ast$}]{output\+Len }\end{DoxyParamCaption})}
...
\mbox{\tt in,out}  & {\em input} & Pointer to the P\+EM structure \\
\hline
\mbox{\tt in,out}  & {\em input\+Len} & Length of the P\+EM structure \\
\hline
\mbox{\tt in,out}  & {\em output} & Pointer to the D\+ER encoded certificate \\
\hline
\mbox{\tt in,out}  & {\em output\+Size} & Size of the memory block that holds the D\+ER certificate \\
\hline
\mbox{\tt out}  & {\em output\+Len} & Length of the D\+ER encoded certificate \\
\hline
\end{DoxyParams}
...
Definition at line 2482 of file pem\+\_\+import.\+c.


\begin{DoxyCode}
2484 \{
2485    \hyperlink{error_8h_ac7659d73a8cdedc08e9f566bb406689c}{error\_t} error;
2486    \textcolor{keywordtype}{size\_t} \hyperlink{dtls__misc_8h_ab43ca82dd7fa2a0e56f941032ef324c4}{length};
2487    \textcolor{keywordtype}{size\_t} i;
2488    \textcolor{keywordtype}{size\_t} j;
2489    \hyperlink{compiler__port_8h_a022c65af7f6c8d3947e8a37d64db6ad6}{int\_t} \hyperlink{md5_8c_af11ea3cdbca7345eb6a4a8ac5ce0434d}{k};
2490 
2491    \textcolor{comment}{//Check parameters}
2492    \textcolor{keywordflow}{if}(input == \hyperlink{group__BSPDefine_ga070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL} || inputLen == \hyperlink{group__BSPDefine_ga070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL})
2493       \textcolor{keywordflow}{return} \hyperlink{error_8h_ac7659d73a8cdedc08e9f566bb406689caeae4b12e06d727d085f75f79a820f2e8}{ERROR\_INVALID\_PARAMETER};
2494    \textcolor{keywordflow}{if}(output == \hyperlink{group__BSPDefine_ga070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL} || outputSize == \hyperlink{group__BSPDefine_ga070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL} || outputLen == \hyperlink{group__BSPDefine_ga070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL})
2495       \textcolor{keywordflow}{return} \hyperlink{error_8h_ac7659d73a8cdedc08e9f566bb406689caeae4b12e06d727d085f75f79a820f2e8}{ERROR\_INVALID\_PARAMETER};
2496 
2497    \textcolor{comment}{//Search for the beginning tag}
2498    k = \hyperlink{certificate_2pem__import_8c_a9019bb246bd8a7c6abeae29608050d5b}{pemSearchTag}(*input, *inputLen, \textcolor{stringliteral}{"-----BEGIN CERTIFICATE-----"}, 27);
2499    \textcolor{comment}{//Failed to find the specified tag?}
2500    \textcolor{keywordflow}{if}(k < 0)
2501       \textcolor{keywordflow}{return} \hyperlink{error_8h_ac7659d73a8cdedc08e9f566bb406689ca488b657f8cc2e6c29df47f282e8ff3ad}{ERROR\_END\_OF\_FILE};
2502 
2503    \textcolor{comment}{//Advance the input pointer over the tag}
2504    *input += k + 27;
2505    *inputLen -= k + 27;
2506 
2507    \textcolor{comment}{//Search for the end tag}
2508    k = \hyperlink{certificate_2pem__import_8c_a9019bb246bd8a7c6abeae29608050d5b}{pemSearchTag}(*input, *inputLen, \textcolor{stringliteral}{"-----END CERTIFICATE-----"}, 25);
2509    \textcolor{comment}{//Invalid PEM file?}
2510    \textcolor{keywordflow}{if}(k <= 0)
2511       \textcolor{keywordflow}{return} \hyperlink{error_8h_ac7659d73a8cdedc08e9f566bb406689ca92e7b26953f11d1bc4f4526fad39aed0}{ERROR\_INVALID\_SYNTAX};
2512 
2513    \textcolor{comment}{//Length of the PEM structure}
2514    length = \hyperlink{md5_8c_af11ea3cdbca7345eb6a4a8ac5ce0434d}{k};
2515 
2516    \textcolor{comment}{//Increase buffer size?}
2517    \textcolor{keywordflow}{if}(length > *outputSize)
2518    \{
2519       \textcolor{comment}{//Release previously allocated buffer if necessary}
2520       \textcolor{keywordflow}{if}(*output != \hyperlink{group__BSPDefine_ga070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL})
2521       \{
2522          \hyperlink{cyclone__crypto_2core_2crypto_8h_ac8a223b176683db4e9eed4162774f870}{cryptoFreeMem}(*output);
2523          *output = \hyperlink{group__BSPDefine_ga070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL};
2524          *outputSize = 0;
2525       \}
2526 
2527       \textcolor{comment}{//Allocate a memory buffer to hold the decoded data}
2528       *output = \hyperlink{cyclone__crypto_2core_2crypto_8h_a48b53d16f66d31e5dcf82db3c1b882ba}{cryptoAllocMem}(length);
2529       \textcolor{comment}{//Failed to allocate memory?}
2530       \textcolor{keywordflow}{if}(*output == \hyperlink{group__BSPDefine_ga070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL})
2531          \textcolor{keywordflow}{return} \hyperlink{error_8h_ac7659d73a8cdedc08e9f566bb406689cac0a554045048d2fb61387cf735676f69}{ERROR\_OUT\_OF\_MEMORY};
2532 
2533       \textcolor{comment}{//Record the size of the buffer}
2534       *outputSize = \hyperlink{dtls__misc_8h_ab43ca82dd7fa2a0e56f941032ef324c4}{length};
2535    \}
2536 
2537    \textcolor{comment}{//Copy the contents of the PEM structure}
2538    \hyperlink{cyclone__crypto_2core_2crypto_8h_a6724616c4014bb7e21f2660bd7b88be8}{cryptoMemcpy}(*output, *input, length);
2539 
2540    \textcolor{comment}{//Advance the input pointer over the certificate}
2541    *input += length + 25;
2542    *inputLen -= length + 25;
2543 
2544    \textcolor{comment}{//Remove carriage returns and line feeds}
2545    \textcolor{keywordflow}{for}(i = 0, j = 0; i < \hyperlink{dtls__misc_8h_ab43ca82dd7fa2a0e56f941032ef324c4}{length}; i++)
2546    \{
2547       \textcolor{keywordflow}{if}((*output)[i] != \textcolor{charliteral}{'\(\backslash\)r'} && (*output)[i] != \textcolor{charliteral}{'\(\backslash\)n'})
2548          (*output)[j++] = (*output)[i];
2549    \}
2550 
2551    \textcolor{comment}{//Start of exception handling block}
2552    \textcolor{keywordflow}{do}
2553    \{
2554       \textcolor{comment}{//The contents of the PEM file is Base64-encoded}
2555       error = \hyperlink{base64_8c_ae360cde3e2ef08783ac2e01591b78530}{base64Decode}((\hyperlink{compiler__port_8h_a40bb5262bf908c328fbcfbe5d29d0201}{char\_t} *) *output, j, *output, &length);
2556       \textcolor{comment}{//Failed to decode the file?}
2557       \textcolor{keywordflow}{if}(error)
2558          \textcolor{keywordflow}{break};
2559 
2560       \textcolor{comment}{//Display ASN.1 structure}
2561       error = \hyperlink{asn1_8c_adfebd6c0e21cc4d23414ff98aa9e9a69}{asn1DumpObject}(*output, length, 0);
2562       \textcolor{comment}{//Any error to report?}
2563       \textcolor{keywordflow}{if}(error)
2564          \textcolor{keywordflow}{break};
2565 
2566       \textcolor{comment}{//End of exception handling block}
2567    \} \textcolor{keywordflow}{while}(0);
2568 
2569    \textcolor{comment}{//Clean up side effects}
2570    \textcolor{keywordflow}{if}(error)
2571    \{
2572       \textcolor{comment}{//Release previously allocated memory}
2573       \hyperlink{cyclone__crypto_2core_2crypto_8h_ac8a223b176683db4e9eed4162774f870}{cryptoFreeMem}(*output);
2574       *output = \hyperlink{group__BSPDefine_ga070d2ce7b6bb7e5c05602aa8c308d0c4}{NULL};
2575       *outputSize = 0;
2576    \}
2577 
2578    \textcolor{comment}{//Size of the decoded certificate}
2579    *outputLen = \hyperlink{dtls__misc_8h_ab43ca82dd7fa2a0e56f941032ef324c4}{length};
2580    \textcolor{comment}{//Return status code}
2581    \textcolor{keywordflow}{return} error;
2582 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_a0afa6464bcb0c1a2e17488fef1d3c3a8}\label{certificate_2pem__import_8c_a0afa6464bcb0c1a2e17488fef1d3c3a8}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Dh\+Parameters@{pem\+Import\+Dh\+Parameters}}
\index{pem\+Import\+Dh\+Parameters@{pem\+Import\+Dh\+Parameters}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
...
178 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_a123592ae82dda17101073d06323386b8}\label{certificate_2pem__import_8c_a123592ae82dda17101073d06323386b8}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Dsa\+Private\+Key@{pem\+Import\+Dsa\+Private\+Key}}
\index{pem\+Import\+Dsa\+Private\+Key@{pem\+Import\+Dsa\+Private\+Key}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
...
1266       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPrivateKey_a8f8fd999b327a6bbff828cb04e31772e}{p});
...
1276       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPrivateKey_a57748f022f498aaf35d7b30f562af7ca}{q});
...
1286       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPrivateKey_a78da170adbc7f1a7eeb95e6bc52d4124}{g});
...
1334       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPrivateKey_ac5b101c89f19f59b4cddd85429f1c30e}{x});
...
1342       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structDsaPrivateKey_a8f8fd999b327a6bbff828cb04e31772e}{p});
1343       \hyperlink{debug_8h_a67a8f9bc74358aa21745a76e23768dae}{TRACE\_DEBUG}(\textcolor{stringliteral}{"  q:\(\backslash\)r\(\backslash\)n"});
1344       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structDsaPrivateKey_a57748f022f498aaf35d7b30f562af7ca}{q});
1345       \hyperlink{debug_8h_a67a8f9bc74358aa21745a76e23768dae}{TRACE\_DEBUG}(\textcolor{stringliteral}{"  g:\(\backslash\)r\(\backslash\)n"});
1346       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structDsaPrivateKey_a78da170adbc7f1a7eeb95e6bc52d4124}{g});
1347       \hyperlink{debug_8h_a67a8f9bc74358aa21745a76e23768dae}{TRACE\_DEBUG}(\textcolor{stringliteral}{"  x:\(\backslash\)r\(\backslash\)n"});
1348       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structDsaPrivateKey_ac5b101c89f19f59b4cddd85429f1c30e}{x});
1349 
...
1369 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_a5fc5ddd5c103b7cd6d44bf46dec0fdda}\label{certificate_2pem__import_8c_a5fc5ddd5c103b7cd6d44bf46dec0fdda}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Dsa\+Public\+Key@{pem\+Import\+Dsa\+Public\+Key}}
\index{pem\+Import\+Dsa\+Public\+Key@{pem\+Import\+Dsa\+Public\+Key}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
...
907          error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPublicKey_a273f5bed06a946fd672c94283f49fc3e}{p});
...
917          error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPublicKey_a7961fbb82f0c5c56b577d2247ffc9172}{q});
...
927          error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPublicKey_a910d43db2650efb256373b06521a23bf}{g});
...
964          error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPublicKey_a47d0a3368a5a61e48cc36ed0414392a6}{y});
...
982          error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPublicKey_a47d0a3368a5a61e48cc36ed0414392a6}{y});
...
992          error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPublicKey_a273f5bed06a946fd672c94283f49fc3e}{p});
...
1002          error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPublicKey_a7961fbb82f0c5c56b577d2247ffc9172}{q});
...
1012          error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structDsaPublicKey_a910d43db2650efb256373b06521a23bf}{g});
...
1021       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structDsaPublicKey_a273f5bed06a946fd672c94283f49fc3e}{p});
1022       \hyperlink{debug_8h_a67a8f9bc74358aa21745a76e23768dae}{TRACE\_DEBUG}(\textcolor{stringliteral}{"  q:\(\backslash\)r\(\backslash\)n"});
1023       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structDsaPublicKey_a7961fbb82f0c5c56b577d2247ffc9172}{q});
1024       \hyperlink{debug_8h_a67a8f9bc74358aa21745a76e23768dae}{TRACE\_DEBUG}(\textcolor{stringliteral}{"  g:\(\backslash\)r\(\backslash\)n"});
1025       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structDsaPublicKey_a910d43db2650efb256373b06521a23bf}{g});
1026       \hyperlink{debug_8h_a67a8f9bc74358aa21745a76e23768dae}{TRACE\_DEBUG}(\textcolor{stringliteral}{"  y:\(\backslash\)r\(\backslash\)n"});
1027       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structDsaPublicKey_a47d0a3368a5a61e48cc36ed0414392a6}{y});
1028 
...
1048 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_a5d76a217bb3b6fad9de9aa71bcd8317f}\label{certificate_2pem__import_8c_a5d76a217bb3b6fad9de9aa71bcd8317f}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Ec\+Parameters@{pem\+Import\+Ec\+Parameters}}
\index{pem\+Import\+Ec\+Parameters@{pem\+Import\+Ec\+Parameters}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
...
1667 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_a9d39070535c6536d833ace8e6dedde82}\label{certificate_2pem__import_8c_a9d39070535c6536d833ace8e6dedde82}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Ec\+Private\+Key@{pem\+Import\+Ec\+Private\+Key}}
\index{pem\+Import\+Ec\+Private\+Key@{pem\+Import\+Ec\+Private\+Key}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
\subsubsection{\texorpdfstring{pem\+Import\+Ec\+Private\+Key()}{pemImportEcPrivateKey()}}
{\footnotesize\ttfamily \hyperlink{error_8h_ac7659d73a8cdedc08e9f566bb406689c}{error\+\_\+t} pem\+Import\+Ec\+Private\+Key (\begin{DoxyParamCaption}\item[{const \hyperlink{compiler__port_8h_a40bb5262bf908c328fbcfbe5d29d0201}{char\+\_\+t} $\ast$}]{input,  }\item[{size\+\_\+t}]{length,  }\item[{\hyperlink{structMpi}{Mpi} $\ast$}]{key }\end{DoxyParamCaption})}
...
2117 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_aabfdd540ffe38f75019d501aa50648eb}\label{certificate_2pem__import_8c_aabfdd540ffe38f75019d501aa50648eb}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Ec\+Public\+Key@{pem\+Import\+Ec\+Public\+Key}}
\index{pem\+Import\+Ec\+Public\+Key@{pem\+Import\+Ec\+Public\+Key}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
\subsubsection{\texorpdfstring{pem\+Import\+Ec\+Public\+Key()}{pemImportEcPublicKey()}}
{\footnotesize\ttfamily \hyperlink{error_8h_ac7659d73a8cdedc08e9f566bb406689c}{error\+\_\+t} pem\+Import\+Ec\+Public\+Key (\begin{DoxyParamCaption}\item[{const \hyperlink{compiler__port_8h_a40bb5262bf908c328fbcfbe5d29d0201}{char\+\_\+t} $\ast$}]{input,  }\item[{size\+\_\+t}]{length,  }\item[{\hyperlink{structEcPoint}{Ec\+Point} $\ast$}]{key }\end{DoxyParamCaption})}
...
1851       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structEcPoint_a08f3fbb7a7d07607306bd8d6200629af}{x});
...
1853       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structEcPoint_a2102dff813849bd0eaed8a1a5e64ec1f}{y});
1854 
...
1875 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_a54cf0a5cee9bf4c0e25866b26f1752e0}\label{certificate_2pem__import_8c_a54cf0a5cee9bf4c0e25866b26f1752e0}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Eddsa\+Private\+Key@{pem\+Import\+Eddsa\+Private\+Key}}
\index{pem\+Import\+Eddsa\+Private\+Key@{pem\+Import\+Eddsa\+Private\+Key}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
...
2441       error = \hyperlink{mpi_8c_a844d59498f4acce9d69ae55570b521f3}{mpiImport}(&key->\hyperlink{structEddsaPrivateKey_a58ef5164bc00df5a7ee8adc18fa2b63a}{d}, tag.\hyperlink{structAsn1Tag_a90f3832fa59c62feb4fb8be9d8b11b29}{value}, tag.\hyperlink{structAsn1Tag_a5131e751817ae2cbfdaf031c2ce97f3d}{length}, 
...
2448       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"  "}, &key->\hyperlink{structEddsaPrivateKey_a58ef5164bc00df5a7ee8adc18fa2b63a}{d});
2449 
...
2469 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_a4b4c81159fa7296b5237335d845867dc}\label{certificate_2pem__import_8c_a4b4c81159fa7296b5237335d845867dc}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Eddsa\+Public\+Key@{pem\+Import\+Eddsa\+Public\+Key}}
\index{pem\+Import\+Eddsa\+Public\+Key@{pem\+Import\+Eddsa\+Public\+Key}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
...
2259       error = \hyperlink{mpi_8c_a844d59498f4acce9d69ae55570b521f3}{mpiImport}(&key->\hyperlink{structEddsaPublicKey_ad64b6fac961042422df3f17bd5f01f9e}{q}, data, length, 
      \hyperlink{mpi_8h_a5fe4159c7c390c604067e854b41d337fa637c0a6e803a47db52875c6818674c60}{MPI\_FORMAT\_LITTLE\_ENDIAN});
...
2266       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"  "}, &key->\hyperlink{structEddsaPublicKey_ad64b6fac961042422df3f17bd5f01f9e}{q});
2267 
...
2287 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_a3d276f00ad49589056269bfe8abbb664}\label{certificate_2pem__import_8c_a3d276f00ad49589056269bfe8abbb664}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Rsa\+Private\+Key@{pem\+Import\+Rsa\+Private\+Key}}
\index{pem\+Import\+Rsa\+Private\+Key@{pem\+Import\+Rsa\+Private\+Key}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
...
625       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structRsaPrivateKey_aaccaccd76db1a21201bf06eb6ecdd8ac}{n});
...
635       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structRsaPrivateKey_a590822495b6caceae5f8880cacc51b9c}{e});
...
645       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structRsaPrivateKey_aea064a2875da9d2a44c7e7c02e157728}{d});
...
655       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structRsaPrivateKey_a1fc8b1ca097c70244db691916f33f891}{p});
...
665       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structRsaPrivateKey_aefd3ef59482ac00637165b624625fef5}{q});
...
675       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structRsaPrivateKey_ab101b4e579a4799f12d3acd237e72b34}{dp});
...
685       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structRsaPrivateKey_a9e72909ef8af48ce9a813ba32ba0287d}{dq});
...
695       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structRsaPrivateKey_a3dac28e0d48293032c18c968faadf57c}{qinv});
...
703       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structRsaPrivateKey_aaccaccd76db1a21201bf06eb6ecdd8ac}{n});
...
705       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structRsaPrivateKey_a590822495b6caceae5f8880cacc51b9c}{e});
...
707       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structRsaPrivateKey_aea064a2875da9d2a44c7e7c02e157728}{d});
...
709       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structRsaPrivateKey_a1fc8b1ca097c70244db691916f33f891}{p});
...
711       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structRsaPrivateKey_aefd3ef59482ac00637165b624625fef5}{q});
...
713       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structRsaPrivateKey_ab101b4e579a4799f12d3acd237e72b34}{dp});
...
715       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structRsaPrivateKey_a9e72909ef8af48ce9a813ba32ba0287d}{dq});
...
717       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structRsaPrivateKey_a3dac28e0d48293032c18c968faadf57c}{qinv});
718 
...
738 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_a93fcb70196ecbfad4c0b907c9d81c00a}\label{certificate_2pem__import_8c_a93fcb70196ecbfad4c0b907c9d81c00a}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Import\+Rsa\+Public\+Key@{pem\+Import\+Rsa\+Public\+Key}}
\index{pem\+Import\+Rsa\+Public\+Key@{pem\+Import\+Rsa\+Public\+Key}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
...
373       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structRsaPublicKey_a51b3d236796d7d46c15d3e6bc7e5acb2}{n});
...
383       error = \hyperlink{asn1_8c_aa73309637560abf8e42288890c19d641}{asn1ReadMpi}(data, length, &tag, &key->\hyperlink{structRsaPublicKey_af293e256864ab9ac9f80d1e6552693da}{e});
...
391       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structRsaPublicKey_a51b3d236796d7d46c15d3e6bc7e5acb2}{n});
...
393       \hyperlink{debug_8h_a9c9f3b28f2daf14d77b401512c189d93}{TRACE\_DEBUG\_MPI}(\textcolor{stringliteral}{"    "}, &key->\hyperlink{structRsaPublicKey_af293e256864ab9ac9f80d1e6552693da}{e});
394 
...
414 \}
\end{DoxyCode}
\mbox{\Hypertarget{certificate_2pem__import_8c_a9019bb246bd8a7c6abeae29608050d5b}\label{certificate_2pem__import_8c_a9019bb246bd8a7c6abeae29608050d5b}} 
\index{certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}!pem\+Search\+Tag@{pem\+Search\+Tag}}
\index{pem\+Search\+Tag@{pem\+Search\+Tag}!certificate/pem\+\_\+import.\+c@{certificate/pem\+\_\+import.\+c}}
\subsubsection{\texorpdfstring{pem\+Search\+Tag()}{pemSearchTag()}}
{\footnotesize\ttfamily \hyperlink{compiler__port_8h_a022c65af7f6c8d3947e8a37d64db6ad6}{int\+\_\+t} pem\+Search\+Tag (\begin{DoxyParamCaption}\item[{const \hyperlink{compiler__port_8h_a40bb5262bf908c328fbcfbe5d29d0201}{char\+\_\+t} $\ast$}]{s,  }\item[{size\+\_\+t}]{s\+Len,  }\item[{const \hyperlink{compiler__port_8h_a40bb5262bf908c328fbcfbe5d29d0201}{char\+\_\+t} $\ast$}]{tag,  }\item[{size\+\_\+t}]{tag\+Len }\end{DoxyParamCaption})}
...
Definition at line 2595 of file pem\+\_\+import.\+c.


\begin{DoxyCode}
2596 \{
2597    \textcolor{keywordtype}{size\_t} i;
2598    \textcolor{keywordtype}{size\_t} j;
2599 
2600    \textcolor{comment}{//Loop through input string}
2601    \textcolor{keywordflow}{for}(i = 0; (i + tagLen) <= sLen; i++)
2602    \{
2603       \textcolor{comment}{//Compare current substring with the given tag}
2604       \textcolor{keywordflow}{for}(j = 0; j < tagLen; j++)
2605       \{
2606          \textcolor{keywordflow}{if}(\hyperlink{md2_8c_adf356ff381033f761b7de5f76e763a45}{s}[i + j] != tag[j])
2607             \textcolor{keywordflow}{break};
2608       \}
2609 
2610       \textcolor{comment}{//Check whether the tag has been found}
2611       \textcolor{keywordflow}{if}(j == tagLen)
2612          \textcolor{keywordflow}{return} i;
2613    \}
2614 
2615    \textcolor{comment}{//The tag does not appear in the string}
2616    \textcolor{keywordflow}{return} -1;
2617 \}
\end{DoxyCode}
