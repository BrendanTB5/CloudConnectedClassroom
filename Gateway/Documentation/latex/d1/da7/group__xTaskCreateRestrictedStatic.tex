\hypertarget{group__xTaskCreateRestrictedStatic}{}\section{x\+Task\+Create\+Restricted\+Static}
\label{group__xTaskCreateRestrictedStatic}\index{x\+Task\+Create\+Restricted\+Static@{x\+Task\+Create\+Restricted\+Static}}
task. h 
\begin{DoxyPre}
