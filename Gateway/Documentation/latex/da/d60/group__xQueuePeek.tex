\hypertarget{group__xQueuePeek}{}\section{x\+Queue\+Peek}
\label{group__xQueuePeek}\index{x\+Queue\+Peek@{x\+Queue\+Peek}}
queue. h 
\begin{DoxyPre}
...
Successfully received items remain on the queue so will be returned again by the next call, or a call to \hyperlink{queue_8h_ae8364d988c6f9b63c771cc2b3dfe5df9}{x\+Queue\+Receive()}.
