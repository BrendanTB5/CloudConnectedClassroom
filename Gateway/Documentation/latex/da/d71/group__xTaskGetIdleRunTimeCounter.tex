\hypertarget{group__xTaskGetIdleRunTimeCounter}{}\section{x\+Task\+Get\+Idle\+Run\+Time\+Counter}
\label{group__xTaskGetIdleRunTimeCounter}\index{x\+Task\+Get\+Idle\+Run\+Time\+Counter@{x\+Task\+Get\+Idle\+Run\+Time\+Counter}}
task. h 
